...
class GameControllerTest {
    ...
    void testNewGameReturnsBoardWithTwoTiles() {
        NewGameResponse res = client.toBlocking().retrieve(
            HttpRequest.POST("/api/game/new", ""), NewGameResponse.class);
    ...
    void testMoveLeftMatchesSpec() {
        ...
        MoveResponse res = client.toBlocking().retrieve(
    ...
    void testAiSuggestReturnsDirection() {
        ...
        AiResponse res = client.toBlocking().retrieve(
            HttpRequest.POST("/api/game/ai-suggest", new AiRequest(board)),
            AiResponse.class);
